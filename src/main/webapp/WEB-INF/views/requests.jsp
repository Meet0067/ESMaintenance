<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" isELIgnored="false" import="com.dao.*,com.bean.*,java.util.*" errorPage="login.jsp" %>  <%@page import="com.bean.UserBean"%>
<!DOCTYPE html>
<html>
<head>
...
<!-- Navbar START -->
<header  style="background-color: #D7CFCD;width: 100%">
...
<%
		...
		if(nb.isEmpty())
		{
			response.sendRedirect("nonewuser");
		}
...
%>			<table>
						...
						%>
								<tr>
									...
									<td class="column7"><%out.print("<a href='approve/" + id +" '>"); %>
									<button class="contact100-form-btn" style=" min-width: 50px; margin-top: 5px;max-height: 40px;min-height: 25px; max-width: 150px;" value="Approve" >Approve</button></a></td>
									<td class="column7"><%out.print("<a href='reject/" + id +" '>"); %>
									<button class="contact100-form-btn" style=" min-width: 50px; margin-top: 5px;max-height: 40px;min-height: 25px; max-width: 150px;"  value="Reject" >Reject</button></a></td>							
