...
<%
       FundDao fd= (FundDao)request.getAttribute("fundDao");
		...
		ArrayList<PaymentBean> pb = (ArrayList<PaymentBean>)fd.getDueFunds(fId);
		System.out.print(pb.isEmpty());
		
		if(pb.isEmpty())
		{
			
			response.sendRedirect("nodue");
		}
			

%><br><br><br>
		<h2 align="center">Due List For Fund ID <%=fId %></h2>
		<br><br><br>
		<div >
