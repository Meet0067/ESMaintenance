...
<%
		VendorDao vd= (VendorDao)request.getAttribute("vendorDao");
		//System.out.println(Integer.parseInt(request.getSession().getAttribute("userid").toString()));
		System.out.print(vd);
		System.out.print("++");
		ArrayList<VendorBean> vb = vd.getVendors();
		...
		<table style="width:90%; margin-left:5%; margin-right:15%">
						<thead>
							<tr class="table100-head">
								<th class="column2">Vendor ID</th>
								<th class="column5">Name</th>
								<th class="column2">Profession</th>
						...
						<%
						for(VendorBean vendor :vb)
						{
							int id = (vendor.getVendorId());
						%>
								<tr>
									<td class="column2"><%= vendor.getVendorId() %></td>
									<td class="column5"><%= vendor.getName() %></td>
									<td class="column2"><%= vendor.getProfession()%></td>
									<td class="column5"><%= vendor.getMobileNo() %></td>
									<td class="column5"><%= vendor.getEmail()%></td>
									<td class="column3"><%= vendor.getHouseNo()%></td>
									<td class="column7"><%out.print("<a href='deletevendor/" + id +" '>"); %>
