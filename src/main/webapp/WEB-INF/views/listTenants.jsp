<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" errorPage="login.jsp" isELIgnored="false" %>  <%@page import="com.bean.*,com.dao.*,java.util.*"%>
<!DOCTYPE html>
<html>
<head>
...
%><br><br><br>
		...
		<table style="width:90%; margin-left:5%; margin-right:15%">
						...
						{
							if(user.getType().equals("Tenant") && user.getStatus().equals("approved"))
							{
								int id = (user.getUserid());
						%>
								<tr>
									<td class="column2"><%= user.getUserid() %></td>
									<td class="column5"><%= user.getFname()+" "+user.getMname()+" "+user.getLname() %></td>
									<td class="column2"><%= user.getFlate_no()%></td>
									<td class="column5"><%= user.getPhone_No() %></td>
									<td class="column5"><%= user.getEmail()%></td>
