<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" errorPage="login.jsp"  import="com.bean.TransactionBean,com.dao.*,java.util.*" %>
<!DOCTYPE html>
<html>
<head>
...
<%
		ArrayList<TransactionBean> tb =null;
		tb = (ArrayList<TransactionBean>)request.getAttribute("transactions");
%><br><br><br>			
<script>
		...
		<table style="width:95%; margin-left:1%; margin-right:15%">
						<thead>
							<tr class="table100-head">
								<th class="column1">Info</th>
								<th class="column3">Amount</th>
								<th class="column6">Payment Date</th>
								
								<th class="column3">Amount Paid</th>					
						...
						<tbody>				
			<%
						for(TransactionBean ttb:tb)
						{
							%>	
						<tr>
									<td class="column1"><%= ttb.getInfo()%></td>
									<td class="column3"><%= ttb.getAmount()%></td>
									
									<td class="column6"><%= ttb.getPaymentdate()%></td>
									<td class="column3"><%= ttb.getDue_amount()%></td>
			
									<td class="column2"><%=ttb.getAuth_code()%></td>			
