  ...
  <!--       <img src="img/CHS.png" alt="logo"  class="main-logo" id="light_logo">
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" method="post" action="save_committee">
				...
				<div class="wrap-input100 validate-input" data-validate="Please Enter Name Of Committee Member">
					<input class="input100" type="text" name="name" placeholder="Full Name">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Please Enter Post Of Committee Member">
					<input class="input100" type="text" name="post" placeholder="Post">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Please Enter House Number Of Committee Member ">
					<input class="input100" type="text" name="house_no" placeholder="House Number">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Please Enter Contact Number Of Committee Member">
					<input class="input100" type="text" name="contact_no" placeholder="Contact Number">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Please Enter Email Of Committee Member">
