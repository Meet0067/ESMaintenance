  ...
  <!--       <img src="img/CHS.png" alt="logo"  class="main-logo" id="light_logo">
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" method="post" action="fund_status">
				<span class="contact100-form-title">
				 Fund Status
				</span>

				
				<div class="wrap-input100 validate-input" data-validate="Please enter Fund ID">
					<input class="input100" type="number" name="fundid" placeholder="Enter Unique Fund ID">
					<span class="focus-input100"></span>
				</div>
					
				<div class="wrap-input100 validate-input" data-validate = "Please select repetition">
					<span style="color: #8f8fa1;text-align: center">&ensp;&ensp; Select Your Option</span>
					<select class="input100"  style="border: none"  name="status" placeholder="Select Your Option">
