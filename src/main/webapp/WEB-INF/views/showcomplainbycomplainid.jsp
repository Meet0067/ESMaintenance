<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" isELIgnored="false" errorPage="login.jsp" %>  <%@page import="com.bean.*"%>
<!DOCTYPE html>
<html>
<head>
...
<%
	NewComplainBean bean = (NewComplainBean)request.getAttribute("bean");
	
	String co_date = bean.getComplain()+"\n\n"+bean.getTime();
	String regarding = bean.getRegarding();
	String defaut = bean.getStatus();
	...
	String cid =Integer.toString(bean.getComplain_no());
	String name = bean.getName();
	 String comment =bean.getComment();
	 if(comment==null){
			 comment="";
	 }
	 String placeholderR ="Your Previous Response Was:\n\n"+comment;
	 String placeholderL ="Your Message:\n\n";
	 String placeholder;
	 if(comment.equals("")){
...
%>
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" method="post" action="../updateComplain/<%=cid %>">
				<span class="contact100-form-title">
					Complain By <%=name %>
				</span>
				<div class="wrap-input100 " >
					<input class="input100" type="text" name="regarding" readonly="readonly"  placeholder="Regarding:     <%=regarding%>">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 " >
					<textarea class="input100"  name="complain" style="resize: none" placeholder="Complain:     <%=co_date%>" readonly="readonly" ></textarea>
					<span class="focus-input100"></span>
				</div>							
				<div class="wrap-input100 validate-input" data-validate = "Please enter your inputs">
					<textarea class="input100" name="comment"   style="resize:none;" placeholder="<%=placeholder %>" ></textarea>
					<span class="focus-input100"></span>
				</div>
								
				<div class="wrap-input100 validate-input" data-validate = "Please select repetition">
					<span style="color: #8f8fa1;text-align: center">&ensp;&ensp; Select Status For This Complain ..</span>
					<select class="input100"    name="status" style="margin-left:15px; margin-top: 11px;width:173px;border:none;">
						<option value="pending" <%=se1 %>>Pending</option>				
						<option value="solved" <%=se2 %>>Solved</option>
						<option value="under review" <%=se3 %>> Under Review</option>
