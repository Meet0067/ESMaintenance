  ...
  <!--       <img src="img/CHS.png" alt="logo"  class="main-logo" id="light_logo">
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" method="post" action="save_notice">
				...
				<div class="wrap-input100 validate-input" data-validate="Please Enter Heading For Notice">
					<input class="input100" type="text" name="notice_heading" placeholder="Heading">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate = "Please enter your Notice">
					<textarea class="input100" name="notice" placeholder="Notice"></textarea>
					<span class="focus-input100"></span>
				</div>
...
<!--Features Section END-->
	...
	%><% 
	for(NoticeBean nba:nb){
	%>
	<div style="height:300px;">
	
		<form class="contact100-form " method="post" action="deletenotice/<%=nba.getNotice_id() %>" >
				
				
				<div class="wrap-input100 ">
					<textarea class="input100" name="notice" placeholder="Notice" style="width:1100px;float: left;padding-left: 180px;">
					<%=nba.getHeading()+"\n\n"%><%=nba.getNotice() + "\n\n" %><%=nba.getDate() %></textarea>
					<span class="focus-input100"></span>
				</div>
				
				<div class="container-contact100-form-btn">
					<a></a>
					<button class="contact100-form-btn" style="float: left;">
						<span>
							<i class="fa fa-paper-plane-o m-r-6" aria-hidden="true"></i>
							Delete
						</span>
