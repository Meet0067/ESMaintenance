...
<!-- Feature Boxes Start -->
  ...
  <div class="container">
    ...
    <div class="row mt-50">
       ...
       <a href="shownoticeuser"> <div class="feature-box">
	...
	<a href="committeeUserList">    
     ...
     <div class="col-md-3 col-sm-6 col-8">
      ...
      <div class="col-md-3 col-sm-6 col-8">
        <a href="showAllTransactions/<%=request.getSession().getAttribute("userid")%>"><div class="feature-box">
