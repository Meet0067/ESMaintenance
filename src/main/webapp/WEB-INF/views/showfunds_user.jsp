<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" isELIgnored="false" %>  <%@page import="com.bean.*,com.dao.*,java.util.*"%>
<!DOCTYPE html>
<html>
<head>
...
%><br><br><br>
		...
		<table style="width:70%; margin-left:15%; margin-right:15%">
						...
						<%
						for(FundIdBean fun:fib)
						{
							System.out.println(fun.getFundId());
						FundBean fund = (FundBean)fd.getFundById(fun.getFundId(),uid);
						FundBean fundfordue = (FundBean)fd.getFundByIdForDue(fun.getFundId(),uid);
						
					//	}
					//	for(FundBean fund :fb)
					//	{
							int id = (fund.getId());
							int fund_id=(fund.getId());
						%>
								<tr>
									<td class="column1"><%= fund.getId() %></td>
									<td class="column2"><%= fund.getType() %></td>
									<td class="column3"><%= fund.getAmount() %></td>
									<td class="column4"><%= fund.getInfo() %></td>
									<td class="column5"><%= fund.getDate()%></td>
									<td class="column6"><%= fundfordue.getDue_amount()%></td>
									
									<td class="column7"><%out.print("<a href='payfund/" +fund_id+"/"+uid +"/"+fundfordue.getDue_amount() +" '>"); %><input type="button" value="Pay" /></td>		
								</tr>
