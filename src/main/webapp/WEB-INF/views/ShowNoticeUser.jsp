...
<br>			
 ...
 <br>
		...
		<table style="width:95%; margin-left:3%; margin-right:10%">
						<thead>
							<tr class="table100-head">
								<th class="column2">Notice ID</th>
								<th class="column2">Heading</th>
								<th class="column6">Notice</th>
					<!-- 			<th class="column6">Complain</th>
						...
						<tbody>
								...
								%>
						<tr>
									<td class="column2"><%= nba.getNotice_id() %></td>
									<td class="column2"><%= nba.getHeading() %></td>
									
									<td class="column6"><%= nba.getNotice()%></td>
									<td class="column2"><%= nba.getDate()%></td>
