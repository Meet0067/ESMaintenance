...
%>
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" method="post" action="save_fund">
				...
				<div class="wrap-input100 " data-validate="Please enter Fund ID">
					<input class="input100" type="number" name="fundid" placeholder=" Unique Fund ID is:   <%=uniqueid%>" readonly="readonly">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Please enter Amount">
					<input class="input100" type="number" name="amount" placeholder="Amounts To Be Paid">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate = "Please enter information about fund">
					<textarea class="input100" name="info" placeholder="Short Info"></textarea>
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter Due date">
					...
					<input class="input100" type="date" name="due_date" placeholder="Enter Due Date">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate = "Please select repetition">
					<span hidden="" style="color: #8f8fa1;text-align: center">&ensp;&ensp; Fund Should Repeated After ..</span>
					<select hidden="" class="input100"  style="margin-left:15px; margin-top: 11px;width:173px;border:none;"  name="rep" placeholder="Fund shoud repeted after ..">
