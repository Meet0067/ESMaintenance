...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" isELIgnored="false" errorPage="login.jsp" %>  <%@page import="com.bean.*,com.services.*, java.util.*"%>
<!DOCTYPE html>
<html>
<head>
...
<% 
	...
	ArrayList<TransactionBean> tb = pd.getAllTransaction(uId);
	...
	for(TransactionBean t : tb){
		...
		if(t.getFundid()==fId)
		{
			System.out.println(t.getAuth_code());
			System.out.println(t.getEmail());
			auth_code = t.getAuth_code();
			amount = t.getAmount();
			email = t.getEmail();
			date = t.getPaymentdate();
			break;
		}
	}
	
	 es.sendPaymentMail(uId, fId, amount, email, date, auth_code);
%>
