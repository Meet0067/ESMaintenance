...
<!--Features Section END-->
	...
	%><!--  
	<div style="height:300px;border-bottom-color: red;border: thin;">
		
				
				<div class="wrap-input100 ">
					<textarea class="input100" name="notice" placeholder="Notice" style="width:1500px;float: left;padding-left: 180px;">
	...
	<div style="height:300px;width:800px;padding-left: 80px;">
				<h1 style="text-align: center;" class="input100" ><font size="25" color="black"><%=nba.getHeading()+"\n\n"%></font></h1><br />
				<p class="input100" style="align-content: center;"><%=nba.getNotice()%></p><br><br>	
				<p class="input100" style="text-align: left;"><%=nba.getDate() %></p>
			</div>
	<%} %>
